...
VERİ HAZIRLAMA (1/3)
====================
Bu dosya RAG hattının ilk aşamasını gerçekleştirir:

    Belge (burclar.txt) -> Parçalama (chunking) -> Embedding -> SQLite

Çalıştırma:
    python veri_hazirlama.py

Kaynak belge değiştiğinde bu script tekrar çalıştırılmalıdır; script
eski kayıtları silip veritabanını yeniden oluşturur.
"""
